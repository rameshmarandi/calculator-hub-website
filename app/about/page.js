export default function AboutPage() {
  return (
    <main className="max-w-3xl mx-auto px-4 py-12">
      <h1 className="text-3xl font-bold mb-4">About EasyCalc</h1>

      <p className="mb-4">
        EasyCalc is a free online calculator platform designed to help users
      ...
      <p className="mb-4">
        EasyCalc is suitable for students, professionals, homeowners, investors,
