...
import { calculateWeightLoss } from "../../../lib/formulas";
    ...
    >
      ...
      <header>
        ...
        <p className="text-sm leading-relaxed">
          Estimate how many calories you should eat daily to lose weight safely.
        </p>
      </header>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          >
            <option value="slow">Slow (−300 kcal/day)</option>
